...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jsxFileName = '/Users/vetcove/www/react-trend/src/components/Trend/Trend.js';
	...
	var _Trend = __webpack_require__(14);
	...
	var Trend = function (_Component) {
	  ...
	  Trend.prototype.render = function render() {
	    ...
	    var normalizedValues = (0, _Trend.normalizeDataset)(plainValues, maxValue, {
	      minX: padding,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var normalizeDataset = exports.normalizeDataset = function normalizeDataset(data) {
	  ...
	  // Use the maxValue if one is provided and ignore the Y normalization.
	  var normalizedMax = Math.max.apply(Math, data);
	  var boundariesY = { min: Math.min.apply(Math, data), max: Math.max(normalizedMax, maxValue) };
